...
ADVANCED = [
    ...
    # People costs (indirect labour rates)
    dict(key="people_general_manager", sheet="Costs", cell="B5", label="General Manager", group="People costs", step=50, unit="$/month"),
    dict(key="people_sales_rep", sheet="Costs", cell="B6", label="Sales Representative", group="People costs", step=50, unit="$/month"),
    dict(key="people_services_assistant", sheet="Costs", cell="B7", label="General Services Assistant", group="People costs", step=50, unit="$/month"),
    dict(key="people_aquaponics_consultant", sheet="Costs", cell="B8", label="Aquaponics Consultant", group="People costs", step=10, unit="$/hour"),
    dict(key="people_maintenance", sheet="Costs", cell="B9", label="Maintenance", group="People costs", step=1, unit="$/hour"),
    dict(key="people_legal", sheet="Costs", cell="B10", label="Legal Consultant", group="People costs", step=1, unit="$/hour"),
    dict(key="people_tax", sheet="Costs", cell="B11", label="Tax Consultant", group="People costs", step=1, unit="$/hour"),
    dict(key="people_it", sheet="Costs", cell="B12", label="IT Maintenance", group="People costs", step=1, unit="$/hour"),
    dict(key="people_security", sheet="Costs", cell="B13", label="Security Services", group="People costs", step=1, unit="$/hour"),
    dict(key="people_accountant", sheet="Costs", cell="B14", label="Accountant", group="People costs", step=1, unit="$/hour"),
    dict(key="people_veterinary", sheet="Costs", cell="B15", label="Veterinary", group="People costs", step=1, unit="$/hour"),
    dict(key="people_lab_tech", sheet="Costs", cell="B16", label="Laboratory Technician", group="People costs", step=1, unit="$/hour"),
    dict(key="people_chem_tech", sheet="Costs", cell="B17", label="Chemical Technician", group="People costs", step=1, unit="$/hour"),
    # Operating costs
...
STATIC_ADV_DEFAULTS = dict(
    ...
    people_general_manager=10000,
    people_sales_rep=2000,
    people_services_assistant=0,
    people_aquaponics_consultant=300,
    people_maintenance=20,
    people_legal=34.06,
    people_tax=20,
    people_it=25,
    people_security=0,
    people_accountant=20,
    people_veterinary=20,
    people_lab_tech=20,
    people_chem_tech=20,
)
